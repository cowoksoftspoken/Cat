...
when_join_1:
  ...
  %choice.payload.field.ptr.10 = getelementptr inbounds i8, ptr %choice.payload.base.9, i64 0
...
try_fail_0:
  ...
  %choice.payload.field.15 = load %claw.slice, ptr %choice.payload.field.ptr.14, align 8
  %addr.16 = alloca %claw.slice, align 8
